...
## 安装配置
安装配置相关内容，请参见 [安装](../install/helm-install.html)。
...
![](http://terminus-paas.oss-cn-hangzhou.aliyuncs.com/paas-doc/2021/08/19/a9a867d9-7887-41e9-93a5-abbd995f9bf0.png)

:::tip 提示
若您没有可选集群，请参见  [集群管理](../cmp/guide/cluster/management.html) 完成集群添加。
:::

加入项目后，您的操作主要涉及以下两大功能：
* DevOps
    * 协同
    * 代码托管
    * CI/CD
...
TODO：图示说明从协同到代码到 CI/CD 到微服务治理到测试回归整套流程
...
下文将按上面的软件研发生命周期过程，结合案例进行快速入门的讲解：
1. 需求分析：协同
    * 需求的收集、跟进、过程的落地
3. 研发实现：代码托管 + CI/CD
    * 软件构建、部署、管理
...
:::tip 提示
本文中对软件的架构设计无法作为真实研发活动的指导，仅供快速入门参考。
:::
...
首先需要有两个应用，应用是代码管理和打包部署的最小单位，关于 Erda 应用的解释可以参看详细介绍【link】
